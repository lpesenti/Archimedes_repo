...
def Evaluate_PSD(filexml, ch, dirdata, sensor, tstart, tstop, Twindow, Overlap, verbose):
    ...
    if sensor=='SOE4':
       filename = dirdata+"/"+yi+"/"+sensor+"/ET."+sensor+".."+ch+"_centaur-3_6653_"+yi+str(mi).zfill(2)+str(di).zfill(2)+"_"+str(hi).zfill(2)+str(mii).zfill(2)+str(si).zfill(2)+".miniseed"
    if sensor=='SOE5':
       filename = dirdata+"/"+yi+"/"+sensor+"/ET."+sensor+".."+ch+"_centaur-3_5046_"+yi+str(mi).zfill(2)+str(di).zfill(2)+"_"+str(hi).zfill(2)+str(mii).zfill(2)+str(si).zfill(2)+".miniseed"
    if sensor=='SOE6':
       filename = dirdata+"/"+yi+"/"+sensor+"/ET."+sensor+".."+ch+"_centaur-3_7322_"+yi+str(mi).zfill(2)+str(di).zfill(2)+"_"+str(hi).zfill(2)+str(mii).zfill(2)+str(si).zfill(2)+".miniseed"
#+str(23).zfill(3)+
#  st0 = Stream()
