...
XML_path = r'./'
Data_path = r'D:/ET/P3-P2-preliminary/BKP_Sardegna_P2/2021/09/'
...
if __name__ == '__main__':
    ...
    ET.psd_rms_finder(st_tot, XML_path + XML_file, network, sensor, location, channel, ti, Twindow, Overlap)#, ax0, ax1)
